...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/pix)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/pix
```

A live public deployment of this template is available at [https://pix.templates.workers.dev](https://pix.templates.workers.dev)
